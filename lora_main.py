...
if __name__ == "__main__":
    ...
    try:
        ...
        # set stage to textual inversion
        model.set_stage(0)
        ...
        if opt.scale_lr:
            config.lora_train.params.unet_lora_lr = accumulate_grad_batches * ngpu * bs * config.lora_train.params.unet_lora_lr
            config.lora_train.params.te_lora_lr = accumulate_grad_batches * ngpu * bs * config.lora_train.params.te_lora_lr
            config.lora_train.params.te_ti_lr = accumulate_grad_batches * ngpu * bs * config.lora_train.params.te_ti_lr
            config.lora_train.params.te_ti_continue_lr = accumulate_grad_batches * ngpu * bs * config.lora_train.params.te_ti_continue_lr
        else:
